...
public class QrCodeUtil {
     ...
     * @param character_set    字符集/字符转码格式
    ...
    public static Bitmap modifyLogo(Bitmap bgBitmap, Bitmap logoBitmap) {
        ...
        logoBitmap = ThumbnailUtils.extractThumbnail(logoBitmap, bgWidth * 1 / 6, bgHeigh * 1 / 6, ThumbnailUtils.OPTIONS_RECYCLE_INPUT);
        ...
        canvas.drawBitmap(logoBitmap, (bgWidth - logoBitmap.getWidth()) / 2, (bgHeigh - logoBitmap.getHeight()) / 2, paint);
        canvas.save();// 保存
        canvas.restore();
