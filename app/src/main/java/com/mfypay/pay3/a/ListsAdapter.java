...
public class ListsAdapter extends BaseAdapter {
    ...
    public ListsAdapter(Context mCtx, List<CoinModel> mList) {
        this.mCtx = mCtx;
        this.mList = mList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holde.tv.setText(mList.get(position).getName());
        holde.tv2.setText(mList.get(position).getStatus() == 1 ? "正常" : "禁用");
        return convertView;
    }
