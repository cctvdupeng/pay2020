...
public class WangxinHook implements IP {
            ...
            protected void afterHookedMethod(MethodHookParam methodHookParam) throws Throwable {
                ...
                if ((pkgAlipay().equals(param.processName)) && (!isStart)) {
                    LGU.D("注册支付宝");
                        ...
                        final Context mCtx = (Context) methodHookParam.args[0];
                    isStart = true;
                    ...
                    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            LGU.D("hoquxnxnle");
                            new WangxinHook2().createHongBao(mCtx, mCtx.getClassLoader());
                        }
                    };
...
//                    activity.finish();
    ...
    private void r(final Context ctx) {
        ...
        LGU.D("12334444444444");
        BroadcastReceiver receiver = new BroadcastReceiver() {
            @Override
            public void onReceive(final Context context, Intent intent) {
                LGU.D("====================");

                new WangxinHook2().createHongBao(context, context.getClassLoader());
